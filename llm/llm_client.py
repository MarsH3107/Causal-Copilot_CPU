...
class LLMClient:
    def __init__(self, args=None):
        ...
        if self.provider == 'openai':
            ...
            # default_model = 'deepseek/deepseek-chat-v3-0324:free'  # OpenRouter format: provider/model
            default_model = 'anthropic/claude-sonnet-4'  # OpenRouter format: provider/model
        else:
